...
use App\Role;
//Include las clases de validaciones creadas
...
class RoleController extends Controller
{
    ...
    public function destroy(Role $role)
    {
        ...
        try {
            ...
            //throw $th;
            $errormsg = 'No se pudo eliminar el Rol por:' . $th->getCode();
            alert()->error('Oops...', '"'.$errormsg.'"')->footer('<a href="#">Rol no eliminado</a>');
        }
